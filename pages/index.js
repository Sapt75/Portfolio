      ...
      <div id="main" className="relative">
        <div>
          <div>
              ...
              <div className="container relative z-30 pt-20 pb-12 sm:pt-56 sm:pb-48 lg:pt-64 lg:pb-48">
                <div className="flex flex-col items-center justify-center lg:flex-row">
                  <div className="rounded-full border-8 border-primary shadow-xl">
                    <Image width={240} height={240} src="/assets/img/blog-author.jpg" className="h-48 rounded-full sm:h-56" alt="author" />
                  </div>
                  <div className="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
                    ...
                    <div className="flex flex-col justify-center pt-3 sm:flex-row sm:pt-5 lg:justify-start">
                      ...
                      <div className="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0">
                        <Link href="https://www.facebook.com/profile.php?id=100010429742389" rel="noopener noreferrer" target={'_blank'}>
                          <i className="bx bxl-facebook-square text-2xl text-white hover:text-yellow"></i>
                        </Link>
                        <Link href="https://mobile.twitter.com/SaptarshiNag7 " rel="noopener noreferrer" target={'_blank'}>
                          <i className="bx bxl-twitter text-2xl text-white hover:text-yellow pl-4"></i>
                        </Link>
                        <Link href="https://www.linkedin.com/in/saptarshi-nag-132803234" rel="noopener noreferrer" target={'_blank'}>
                          <i className="bx bxl-linkedin text-2xl text-white hover:text-yellow pl-4"></i>
                        </Link>
                        <Link href="https://instagram.com/marine_rider_12?igshid=YmMyMTA2M2Y=" rel="noopener noreferrer" target={'_blank'}>
                          <i className="bx bxl-instagram text-2xl text-white hover:text-yellow pl-4"></i>
                        </Link>
                      </div>
                    </div>
                  </div>
              ...
              <div className="container flex flex-col items-center py-16 md:py-20 lg:flex-row">
                <div className="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
                  ...
                  <h4 className="pt-6 font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl">
                    I'm Saptarshi Nag, a Web Designer & Photographer
                  </h4>
                  <p className="pt-6 font-body leading-relaxed text-grey-20">
                    ...
                    I’m extremely passionate about web development and design in all it’s forms and trying to learn new things every day. Aside from web development, I enjoy spending my time with friends, taking photos and playing & watching sports (football, cricket, and mixed martial arts to name a few).
                  </p>
                  <div className="flex flex-col justify-center pt-6 sm:flex-row lg:justify-start">
                    ...
                    <div className="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0">
                      ...
                      <Link href="https://mobile.twitter.com/SaptarshiNag7 " rel="noopener noreferrer" target={'_blank'}>
                        <i className="bx bxl-twitter text-2xl text-primary hover:text-yellow pl-4"></i>
                      </Link>
                      <Link href="https://www.linkedin.com/in/saptarshi-nag-132803234" rel="noopener noreferrer" target={'_blank'}>
                        <i className="bx bxl-linkedin text-2xl text-primary hover:text-yellow pl-4"></i>
                      </Link>
                      <Link href="https://instagram.com/marine_rider_12?igshid=YmMyMTA2M2Y=" rel="noopener noreferrer" target={'_blank'}>
                        <i className="bx bxl-instagram text-2xl text-primary hover:text-yellow pl-4"></i>
                      </Link>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-grey-50" id="expertise">
            ...
            <div className="container py-16 md:py-20" id="contact">
              ...
              <form className="mx-auto w-full pt-10 sm:w-3/4">
                <div className="flex flex-col md:flex-row">
                  <input className="mr-3 w-full rounded border-grey-100 px-4 py-3 font-body text-black md:w-1/2 lg:mr-5"
                    placeholder="Name" type="text" id="name" />
                  <input
                    className="mt-6 w-full rounded border-grey-100 px-4 py-3 font-body text-black md:mt-0 md:ml-3 md:w-1/2 lg:ml-5"
                    placeholder="Email" type="text" id="email" />
                </div>
                <textarea className="mt-6 w-full rounded border-grey-100 px-4 py-3 font-body text-black md:mt-8"
          ...
          <div className="bg-primary">
            <div className="container flex flex-col justify-between py-6 sm:flex-row">
              ...
              <div className="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0">
                ...
                <Link href="https://mobile.twitter.com/SaptarshiNag7 " target={'_blank'}>
                  <i className="bx bxl-twitter text-2xl text-white hover:text-yellow pl-4"></i>
                </Link>
                <Link href="https://www.linkedin.com/in/saptarshi-nag-132803234" target={'_blank'}>
                  <i className="bx bxl-linkedin text-2xl text-white hover:text-yellow pl-4"></i>
                </Link>
                <Link href="https://instagram.com/marine_rider_12?igshid=YmMyMTA2M2Y=" target={'_blank'}>
                  <i className="bx bxl-instagram text-2xl text-white hover:text-yellow pl-4"></i>
                </Link>
              </div>
            </div>
...
{/* // <div className="home mx-8">
    //   <h1>{blogs.blog[0].title}</h1>
    //   <div className="mx-8">
    //     <PortableText
    //       // Pass in block content straight from Sanity.io
    //       content={blogs.blog[0].content}
    //       projectId="n6h0e0q4"
    //       dataset="production"
